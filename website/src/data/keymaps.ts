		...
		keymaps: {
			a: {
				...
				keymaps: {
					...
					r: {
						label: "Recent",
						description: "Open recently visited documents across all workspace",
						notes: "If available.",
					},
					s: {
						label: "Settings",
						...
						notes:
							"In Neovim this would let us fuzzy find config files, and on a mac app this would lead us to `settings.json`. (cmd-,)",
					},
			...
			w: {
				...
				keymaps: {
					...
					f: {
						...
						notes:
							"Optional: Maybe not needed, if the editor offers a replace field under `<leader>wt`.",
					},
					j: {
						label: "Jumps",
					...
					r: {
						...
						notes:
							"Optional: Maybe not needed, if editor merges recently opened documents in `<leader>wd`.",
					},
					...
					v: {
						...
						keymaps: {
							...
							H: {
								label: "History",
								description: "Show version history (interactive)",
							...
							p: {
								...
								keymaps: {
									...
									d: {
										label: "Description",
										description: "Show current PR description",
										notes: "If available (GitHub integration)",
									},
								},
							},
							...
							s: {
								label: "Status",
								description: "Show version status (interactive)",
								notes: "If available (e.g., LazyGit)",
							},
						},
					},
					w: {
						...
						notes:
							"Optional: Maybe not needed if the editor uses the selection under the cursor when using `<leader>wt`.",
					},
				},
			},
			d: {
				...
				keymaps: {
					...
					v: {
						...
						keymaps: {
							h: {
								label: "History",
								description: "Show document version history (picker)",
							},
							H: {
								label: "History",
								description: "Show document version history (interactive)",
								notes: "If available (e.g., LazyGit)",
							},
			...
			s: {
				...
				keymaps: {
					...
					l: {
						...
						notes:
							"If available. (e.g. Programmatically log symbol under cursor)",
					},
